...
arquivo_entrada = os.path.join(INICIAL_SETINGS.pasta_de_processos,'quebra-linha.xlsx')
arquivo_saida = os.path.join(INICIAL_SETINGS.pasta_de_processos,'4-EXTRACT_N_PRODUCTS-TO_FACT.xlsx')
